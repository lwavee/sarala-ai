...
export default function LiveControls({
  ...
  return (
    <div className="w-full max-w-lg mx-auto px-2 sm:px-4 z-30 select-none pb-1 sm:pb-0">
      {/* Authentic Video Call Controls Dock */}
      <div className="glass rounded-full p-1.5 sm:p-2.5 md:p-3 flex items-center justify-around border border-white/20 bg-black/80 backdrop-blur-2xl shadow-2xl gap-1 sm:gap-2">
        
        {/* 1. Mute / Unmute Sarala Speaker */}
        <button
          onClick={onToggleMute}
          aria-label={isMuted ? "Unmute Sarala speaker" : "Mute Sarala speaker"}
          className={`p-2.5 sm:p-3.5 rounded-full border transition-all transform hover:scale-110 cursor-pointer shrink-0 ${
            isMuted
        ...
        <button
          ...
          className={`p-3.5 sm:p-5 rounded-full border transition-all transform hover:scale-110 shadow-2xl cursor-pointer shrink-0 ${
            isListening
        ...
        <button
          ...
          className={`p-2.5 sm:p-3.5 rounded-full border transition-all transform hover:scale-110 cursor-pointer relative shrink-0 ${
            isChatOpen
        ...
        <button
          ...
          className="p-2.5 sm:p-3.5 rounded-full bg-red-600 hover:bg-red-500 border border-red-400 text-white transition-all transform hover:scale-110 shadow-xl shadow-red-600/40 cursor-pointer shrink-0"
